...
urlpatterns = [
    ...
    path('api/v1/user/upload-profile-picture/', UploadProfilePictureView.as_view(), name='upload_profile_picture'),
    path('api/v1/user/update-profile/', UpdateProfileView.as_view(), name='update_profile'),
]
